angular.module('PMAPP').controller('ContactsController', ['$http', '$log', '$scope', '$rootScope', '$location',
        ...
        this.loadParts = function(){
            ...
            $http.get(url).then(// success call back
                ...
                // into the list of parts in the controller.
                    ...
                    thisCtrl.contactsList = response.data.Users;
            ...
            $log.error("Users Loaded: ", JSON.stringify(thisCtrl.contactsList));
        };
